...
function addHandler(e, t, i, n, s) {
  ...
  var h = getUidEvent(r, t.replace(namespaceRegex, "")),
...
var EventHandler = {
  ...
  trigger: function trigger(e, t, i) {
    ...
    return o && n && (a = n.Event(t, i), n(e).trigger(a), l = !a.isPropagationStopped(), c = !a.isImmediatePropagationStopped(), _ = a.isDefaultPrevented()), r ? (h = document.createEvent("HTMLEvents"), h.initEvent(s, l, !0)) : h = new CustomEvent(t, {
      bubbles: l,
      cancelable: !0
    ...
    }), _ && h.preventDefault(), c && e.dispatchEvent(h), h.defaultPrevented && void 0 !== a && a.preventDefault(), h;
  }
},
    elementMap = new Map();
var Data = {
    ...
    value: function _setActiveIndicatorElement(e) {
      if (this._indicatorsElement) {
        ...
        for (var _t2 = 0; _t2 < i.length; _t2++) {
          if (Number.parseInt(i[_t2].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(e)) {
            i[_t2].classList.add("active"), i[_t2].setAttribute("aria-current", "true");
            break;
          }
        }
      }
    ...
    value: function _slide(e, t) {
      ...
      if (this._element.classList.contains("slide")) {
        ...
        var _e3 = function _e3() {
          o.classList.remove(c, _), o.classList.add("active"), n.classList.remove("active", _, c), _this7._isSliding = !1, setTimeout(E, 0);
        };
...
function (_BaseComponent4) {
  ...
  function Collapse(e, t) {
    ...
    for (var _e4 = 0, _t3 = i.length; _e4 < _t3; _e4++) {
      var _t4 = i[_e4],
          n = getSelectorFromElement(_t4),
          s = SelectorEngine.find(n).filter(function (e) {
        return e === _this8._element;
      });
      null !== n && s.length && (_this8._selector = n, _this8._triggerArray.push(_t4));
    }
  ...
  _createClass(Collapse, [{
    ...
    value: function hide() {
      ...
      for (var _e6 = 0; _e6 < t; _e6++) {
        var _t5 = this._triggerArray[_e6],
            _i2 = getElementFromSelector(_t5);

        _i2 && !this._isShown(_i2) && this._addAriaAndCollapsedClass([_t5], !1);
      }
...
function (_BaseComponent5) {
  ...
  _createClass(Dropdown, [{
    ...
    key: "_getConfig",
    value: function _getConfig(e) {
      if (e = _objectSpread({}, this.constructor.Default, {}, Manipulator.getDataAttributes(this._element), {}, e), typeCheckConfig(NAME$9, e, this.constructor.DefaultType), "object" == _typeof(e.reference) && !isElement(e.reference) && "function" != typeof e.reference.getBoundingClientRect) throw new TypeError(NAME$9.toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
      return e;
    }
  }, {
    key: "_createPopper",
      ...
      for (var _i3 = 0, n = t.length; _i3 < n; _i3++) {
        ...
        if (e) {
          var _t6 = e.composedPath(),
              _i4 = _t6.includes(_n4._menu);

          if (_t6.includes(_n4._element) || "inside" === _n4._config.autoClose && !_i4 || "outside" === _n4._config.autoClose && _i4) continue;
...
var uriAttrs = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
  ...
  for (var _e7 = 0, _t7 = n.length; _e7 < _t7; _e7++) {
...
function sanitizeHtml(e, t, i) {
  ...
  for (var _e8 = 0, _i5 = o.length; _e8 < _i5; _e8++) {
...
function (_BaseComponent8) {
  ...
  _createClass(Tooltip, [{
    ...
    key: "dispose",
    value: function dispose() {
      clearTimeout(this._timeout), EventHandler.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.tip && this.tip.remove(), this._popper && this._popper.destroy(), _get(_getPrototypeOf(Tooltip.prototype), "dispose", this).call(this);
    }
  }, {
    key: "show",
    value: function show() {
    ...
    value: function hide() {
      ...
      this._queueCallback(function () {
        _this36._isWithActiveTrigger() || ("show" !== _this36._hoverState && e.remove(), _this36._cleanTipClass(), _this36._element.removeAttribute("aria-describedby"), EventHandler.trigger(_this36._element, _this36.constructor.Event.HIDDEN), _this36._popper && (_this36._popper.destroy(), _this36._popper = null));
  ...
  _createClass(ScrollSpy, [{
    ...
    value: function _process() {
      ...
      if (this._scrollHeight !== t && this.refresh(), e >= i) {
        ...
        for (var _t8 = this._offsets.length; _t8--;) {
          this._activeTarget !== this._targets[_t8] && e >= this._offsets[_t8] && (void 0 === this._offsets[_t8 + 1] || e < this._offsets[_t8 + 1]) && this._activate(this._targets[_t8]);
        }
      }
    }
  }, {
...
function (_BaseComponent10) {
  ...
  _createClass(Tab, [{
    ...
    value: function show() {
      ...
      if (i) {
        var _t9 = "UL" === i.nodeName || "OL" === i.nodeName ? SELECTOR_ACTIVE_UL : ".active";

        e = SelectorEngine.find(_t9, i), e = e[e.length - 1];
      }
    ...
    value: function _transitionComplete(e, t, i) {
      ...
      if (n && "LI" === n.nodeName && (n = n.parentNode), n && n.classList.contains("dropdown-menu")) {
        var _t10 = e.closest(".dropdown");

        _t10 && SelectorEngine.find(".dropdown-toggle", _t10).forEach(function (e) {
          return e.classList.add("active");
