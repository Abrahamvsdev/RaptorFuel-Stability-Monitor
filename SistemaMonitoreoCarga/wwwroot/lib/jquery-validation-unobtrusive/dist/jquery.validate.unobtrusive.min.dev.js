...
!function (a) {
    ...
    return t || (t = {
      options: {
        ...
        errorPlacement: function errorPlacement() {
          ...
          }.apply(n, arguments), a("errorPlacement", arguments);
        },
        invalidHandler: function invalidHandler() {
          ...
          }.apply(n, arguments), a("invalidHandler", arguments);
        },
        messages: {},
        rules: {},
        success: function success() {
          ...
          }.apply(n, arguments), a("success", arguments);
        }
      },
  ...
  return o.unobtrusive = {
    adapters: [],
    parseElement: function parseElement(t, a) {
      var e,
          i,
          r,
          o = s(t),
  ...
  }), o.methods.extension ? (a.addSingleVal("accept", "mimtype"), a.addSingleVal("extension", "extension")) : a.addSingleVal("extension", "extension", "accept"), a.addSingleVal("regex", "pattern"), a.addBool("creditcard").addBool("date").addBool("digits").addBool("email").addBool("number").addBool("url"), a.addMinMax("length", "minlength", "maxlength", "rangelength").addMinMax("range", "min", "max", "range"), a.addMinMax("minlength", "minlength").addMinMax("maxlength", "minlength", "maxlength"), a.add("equalto", ["other"], function (a) {
